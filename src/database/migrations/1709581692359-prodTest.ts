...
export class ProdTest1709581692359 implements MigrationInterface {
    name = 'ProdTest1709581692359'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "otp_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "otp" character varying NOT NULL, "type" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "expiresAt" TIMESTAMP NOT NULL, CONSTRAINT "UQ_57cdd6627522346e3fa94a39a7c" UNIQUE ("email"), CONSTRAINT "PK_af69f5d9d41ea2100820431b72e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "email-verification" ("id" SERIAL NOT NULL, "email" character varying NOT NULL, "emailToken" character varying NOT NULL, "timestamp" TIMESTAMP NOT NULL, CONSTRAINT "UQ_599c4e5b6df138345df3596751c" UNIQUE ("email"), CONSTRAINT "PK_10e4ba7091f9d293d5f34d87286" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "forgotten-password" ("id" SERIAL NOT NULL, "email" character varying NOT NULL, "newPasswordToken" character varying NOT NULL, "timestamp" TIMESTAMP NOT NULL, CONSTRAINT "UQ_52a24706c42aca38176121ebfaf" UNIQUE ("email"), CONSTRAINT "PK_692554284d39999f8624d8debc2" PRIMARY KEY ("id"))`);
